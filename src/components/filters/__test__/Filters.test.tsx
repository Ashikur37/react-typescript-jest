...
describe("Filters", () => {
  test("should be able to change value of favourite select", () => {
    ...
    const select: HTMLSelectElement = screen.getByLabelText(/favourite/i);
    expect(select).toBeInTheDocument();
    userEvent.selectOptions(select, "any");
  ...
  test("should be able to change value of gender select", () => {
    ...
    const select: HTMLSelectElement = screen.getByLabelText(/gender/i);
    userEvent.selectOptions(select, "any");
    expect(select.value).toBe("any");
